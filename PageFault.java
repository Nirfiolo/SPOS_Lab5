...
public class PageFault {
   ...
   */
  public static void replacePage ( Vector mem , int virtPageNum , int replacePageNum , ControlPanel controlPanel, BitMatrix bitMatrix ) 
  {
    int lru = bitMatrix.getLRU();

    Page page = (Page) mem.elementAt(lru);
    Page nextpage = (Page) mem.elementAt(replacePageNum);

    controlPanel.removePhysicalPage(lru);
